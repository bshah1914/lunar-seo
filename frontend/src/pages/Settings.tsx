...
const integrations = [
  { name: 'Google Ads', description: 'Manage PPC campaigns and bidding', connected: true, icon: '🔍' },
  ...
  { name: 'Google Analytics', description: 'Website traffic and behavior analytics', connected: true, icon: '📊' },
  { name: 'Google Search Console', description: 'Search performance and indexing', connected: true, icon: '🌐' },
]
              ...
              <div className="space-y-6">
                <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <div className="mt-4">
                    ...
                    <input
                      type="email"
                      defaultValue="john@marketingos.io"
                      className="w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                    />
                  </div>
